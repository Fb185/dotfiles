function showHelpMenu(state) {
  ...
  if (state) {
    ...
    setTimeout(() => help.style.opacity = "1", 500);
      document.getElementById("help-text").innerHTML = "Supported commands: whoami, date, locale, cores, browser, uname, help, clear<br><br>Supported commands that use flags/arguments: startpage -l/-v/-c/-n, title, echo<br><br>Mode specific commands: :q";
  }
  else {
    input.focus();
    input.value = '';
